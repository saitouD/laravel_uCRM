...
defineProps({
    customers: Object, //paginateしてDBから受け取る場合は、形式が変わるのでarrayでなくObjectにする。
})

const search = ref('')

const searchCustomers = () => {
    Inertia.get(route('customers.index', { search: search.value })) //refの値を受け取るのにvalueをつける必要がある。
}
</script>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font">
                            ...
                            <Pagination class="mt-6" :links="customers.links"></Pagination> <!-- customers Object内にペじネーションに必要な要素、ページのリンクとか入っていいる-->
                            </section>
                    </div>
                </div>
            </div>
