...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">購買一覧</h2>
        </template>
                    ...
                    <div class="p-6 text-gray-900">
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <Link as="button" :href="route('customers.create')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">購買登録</Link>
                                </div>
                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tr v-for="order in props.orders.data" :key="order.id">
                                        <!--ぺじネーションして受け取った場合、Objectのdata内に配列が格納される-->
                            ...
                            <Pagination class="mt-6" :links="props.orders.links"></Pagination> <!-- customers Object内にペじネーションに必要な要素、ページのリンクとか入っていいる-->
                            </section>
                    </div>
                </div>
            </div>
