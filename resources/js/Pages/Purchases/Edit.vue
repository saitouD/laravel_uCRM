                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input radio type="radio" id="status" v-model="form.status" name="status" value="0">キャンセルする
                          <input radio type="radio" id="status" v-model="form.status" name="status" value="1">未キャンセル
                        </div>
                      </div>
